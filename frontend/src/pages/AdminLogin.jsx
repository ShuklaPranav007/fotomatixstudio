  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '6px' }}>Admin Login</h2>
        <p style={{ fontSize: '13px', color: '#888', marginBottom: '28px' }}>Shubham Studio dashboard</p>

        {error && (
          <div style={{
            background: '#fff0f0', border: '0.5px solid #ffd5d5',
        ...
        <div style={{ marginBottom: '14px' }}>
          ...
          <input
            ...
            style={{
              ...
              border: '0.5px solid #ddd', borderRadius: '8px', outline: 'none',
            }}
          />
        </div>
