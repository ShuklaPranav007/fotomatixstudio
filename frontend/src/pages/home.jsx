    ...
    <div>
      ...
      <section id="work">
        ...
        <div style={{ padding: '24px 32px 56px' }}>
          {loading ? (
            <p style={{ color: '#888', fontSize: '14px', textAlign: 'center', padding: '40px 0' }}>Loading...</p>
          ) : media.length === 0 ? (
            <p style={{ color: '#aaa', fontSize: '14px', textAlign: 'center', padding: '60px 0' }}>
      ...
      <section id="about" style={{
        ...
        <div style={{ flex: 1, minWidth: '240px' }}>
          <h2 style={{ fontSize: '22px', fontWeight: 600, marginBottom: '10px' }}>Shubham — Photographer & Filmmaker</h2>
          <p style={{ fontSize: '14px', color: '#555', lineHeight: 1.8, maxWidth: '560px' }}>
            ...
            I bring a cinematic eye and a personal touch to every shoot. My goal is simple — to tell your story beautifully.
          </p>
        </div>
      </section>
